...
<head>
  ...
  <title>DX Waterpark | Inbox</title>
               ...
               <div class="form-group">
                 <h1><b><center><?=$pesans['id_tiket'];?></center></b></h1><hr>
                  ...
                  <div class="form-group">
                    ...
                    <input readonly="" readonly="" type="number" min="1" value="<?=$pesans['total'];?>" class="form-control"  required="" name="total" id="total" placeholder="">
                  </div>
                </div>
