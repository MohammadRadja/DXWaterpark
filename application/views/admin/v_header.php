...
<header class="main-header">
    ...
    <!-- Logo -->
    <a href="" style="background-color:#E8552B;" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><img style="width:20px;" src="<?php echo base_url('assets/img/A2.PNG')?>" alt="" class="img-fluid mb-3"></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">DX Waterpark</span>
    </a>
                ...
                ?>
                  <li><!-- start message -->
                    <a href="<?php echo base_url().'admin/inbox'?>">
                      <div class="pull-left">
                        <img src="<?php echo base_url().'assetsadm/images/user_blank.png'?>" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        <?php echo $inbox_nama;?>
