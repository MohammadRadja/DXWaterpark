...
<body>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center mb-5">
    ...
    <h2>Cari Data tiketmu dengan mengetik nama atau alamat email</h2>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-9">
                    ...
                    <?php elseif ($tiket['status']==2): ?>
                      <form action="<?php echo base_url('tiket/laporan_pdf');?>" method="post" data-target="#modaltambah<?=$tiket['id_tiket'];?>">
               ...
               <div class="form-group">
                 <h1><b><center><?=$tkt['id_tiket'];?></center></b></h1><hr>
                  ...
                  <div class="form-group">
                    ...
                    <input readonly="" disabled="" type="number" min="1" value="<?=$tkt['total'];?>" class="form-control"  required="" name="total" id="total" placeholder="">
                  </div>
                </div>
